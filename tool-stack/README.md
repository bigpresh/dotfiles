...
links, etc.  I hope it may be useful to someone, in addition to being
useful to me for easy reference (particularly the `apt-packages-*.list` and
`perlmodules` lists that I can pass to `apt` / `cpanm` on a new box to install
all the things I like to have.
