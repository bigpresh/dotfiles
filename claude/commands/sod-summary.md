...
Format this as a clean list I can refer back to during the day, with ticket/PR numbers and links I can use to get straight to each issue and PR. Flag anything time-sensitive or risky prominently.
